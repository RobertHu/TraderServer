...
public partial class SecurityServices : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks/>
    public System.IAsyncResult BeginCheckPermissionByParticipant(System.Guid participantID, string participantName, System.Guid loginUserID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("CheckPermissionByParticipant", new object[] {
                    participantID,
                    participantName,
                    loginUserID}, callback, asyncState);
    }
    ...
    /// <remarks/>
    public System.Data.DataSet EndCheckPermissionByParticipant(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((System.Data.DataSet)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginCheckPermission2(System.Guid participantID, System.Guid loginUserID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("CheckPermission2", new object[] {
                    participantID,
                    loginUserID}, callback, asyncState);
    }
    
    /// <remarks/>
    public System.Data.DataSet EndCheckPermission2(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((System.Data.DataSet)(results[0]));
    }
